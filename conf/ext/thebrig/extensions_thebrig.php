...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
	...
	{ echo '<center><a href="extensions_thebrig.php?name='.$n_jail['jailname'].'&action=start"><img src="ext/thebrig/on_small.png" title="Jail start" border="0" alt="Jail start" /></a></center>';} 
		...
		<select name='gl_statfs' class='formfld' id='gl_statfs' ><option value='2' <?php if (2 == $config['thebrig']['gl_statfs']) echo "selected"; ?> >2</option>
																<option value='1' <?php if (1 == $config['thebrig']['gl_statfs']) echo "selected"; ?> >1</option>
																<option value='0' <?php if (0 == $config['thebrig']['gl_statfs']) echo "selected"; ?> >0</option>
		</select>
